...
The purpose of this repo is to host the files necessary to complete Project 2. These include this very `README.md` file (and the `README.Rmd` file, which was knit to create said file), along with the following:
